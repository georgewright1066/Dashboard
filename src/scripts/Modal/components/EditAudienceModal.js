...
export class EditAudienceModal extends React.Component {
  componentDidMount() {
  ...
  render() {
    const { modalOpen, closeModal, panelOverview, panelLoading, panelId, id, getOverviewData } = this.props;
...
export default connect(mapStateToProps, mapDispatchToProps)(EditAudienceModal);
